    ...
    return (
        <div className="sidebar">
            ...
            <Link to="/upload-video">
                <div className={urlPath==="/upload-video"?`sidebar-options active-sidebar-option`:`sidebar-options`}>
                    <MdCloudUpload className="sidebar-options-icons" style={{fontSize: "20px"}}/>
                    <p className="sidebar-options-text">Upload Video</p>
                </div>
            </Link>
            <Link to="/watch-later">
